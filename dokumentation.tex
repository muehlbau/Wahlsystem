...
\item[Wahlkreisergebnis:] \{[ \underline{Legislaturperiode: integer, Wahlkreis: integer}, Gültige: integer, Ungültige: integer, Wähler : integer, Wahlberechtigte: integer ]\}
...
\item[Landesergebnis:] \{[ \underline{Legislaturperiode: integer, Bundesland: varchar}, Gültige: integer, Ungültige: integer, Wähler : integer, Wahlberechtigte: integer ]\}
...
\item[Bundesergebnis:] \{[ \underline{Legislaturperiode: integer}, Gültige: integer, Ungültige: integer, Wähler : integer, Wahlberechtigte: integer ]\}
