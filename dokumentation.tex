...
\item[Bundesland:] \{[ \underline{Name: varchar}, Wappen : blob  ]\}
...
\item[Listenplatz:] \{[ \underline{Landesliste: integer, Position: integer}, Kandidat: integer ]\}

\item[Fraktionspartei:] \{[ \underline{Partei: varchar}, Fraktion: integer ]\}

\item[Fraktionsvorsitz:] \{[ \underline{Kandidat: varchar}, Fraktion: integer ]\}
